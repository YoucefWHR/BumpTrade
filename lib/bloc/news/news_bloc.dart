...
import 'package:bumptrade/standart/news/standart.dart';
  ...
  Stream<NewsState> _fetchNews() async* {
    ...
    try {
      ...
      if (symbolsStored.isNotEmpty) {
        ...
        .wait(symbolsStored
        .map((symbol) async => await _newsRepository.fetchNews(ticker: symbol.symbol)));
        ...
        .map((symbol) async => await _newsRepository.fetchNews(ticker: symbol)));
